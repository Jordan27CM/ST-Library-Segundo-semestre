...
public class ModificarEmpleado extends javax.swing.JPanel {
    ...
    public ModificarEmpleado(App appTemp) {
        initComponents();
        app = appTemp;
    }
    public void setCampos(Usuario usuario){
        ...
        apellidoEmpleado.setText(usuario.getApellido());
        nicknameEmpleado.setText(usuario.getNickname());
        clave1.setText("");
        clave2.setText("");
    }
    ...
    private void initComponents() {
        ...
        labelSubtitulo.setText("MODIFICAR EMPLEADO");
        add(labelSubtitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 750, 100));
        ...
        panelInferior.add(labelNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 70, 30));

        labelNickname.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        labelNickname.setText("Nickname:");
        panelInferior.add(labelNickname, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 73, 30));

        labelApellido.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        labelApellido.setText("Apellido:");
        panelInferior.add(labelApellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 80, 30));
        ...
        panelInferior.add(panelBtnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 300, 150, 30));
        ...
        panelInferior.add(nombreEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 50, 200, 30));
        ...
        panelInferior.add(apellidoEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 200, 30));
        ...
        panelInferior.add(nicknameEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 200, 30));

        labelClave1.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        labelClave1.setText("Clave:");
        panelInferior.add(labelClave1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 50, 40, 30));

        labelClave2.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        labelClave2.setText("Confirmar Clave:");
        panelInferior.add(labelClave2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 100, 120, 30));

        clave1.setText("jPasswordField1");
        clave1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        panelInferior.add(clave1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 50, 240, 30));

        clave2.setText("jPasswordField2");
        clave2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        panelInferior.add(clave2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 170, 30));
    ...
    private void btnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMouseClicked
        try {
            ...
            if(nombre.isEmpty() || apellido.isEmpty() || nickName.isEmpty()){
                ...
                msm.setForeground(Color.red);
                msm.setText("las claves no son iguales o no cumplen con un minimo de 8 digitos");
            }
            
            else if(nickName.contains(" ")){
                msm.setForeground(Color.red);
                msm.setText("el nickname no puede contener espacios");
            }
            else{
                ...
                msm.setText("Empleado modificado con exito");
